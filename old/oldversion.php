...
<div class="main-container d-flex flex-wrap">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Size in mb<?= $product['size'] ?></p>
    <p class="card-text">Width in cm<?= $product['width'] ?></p>
    <p class="card-text">Weight in kg<?= $product['weight'] ?></p>
